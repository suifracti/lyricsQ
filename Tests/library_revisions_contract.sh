...
cd "$ROOT_DIR"
TMP_DIR="$(mktemp -d /tmp/spotifylyrics-library-revisions.XXXXXX)"
...
swiftc -parse-as-library \
  ...
  Tests/library_revisions_contract.swift \
  -o "$TMP_DIR/library-revisions-contract"

"$TMP_DIR/library-revisions-contract"
