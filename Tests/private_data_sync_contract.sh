...
cd "$ROOT_DIR"
TMP_DIR="$(mktemp -d /tmp/spotifylyrics-private-data-sync.XXXXXX)"
...
swiftc -parse-as-library \
  ...
  SpotifyLyrics/Settings/PersonalDataSync.swift \
  ...
  Tests/private_data_sync_contract.swift \
  -o "$TMP_DIR/private-data-sync-contract"

"$TMP_DIR/private-data-sync-contract"
