...
cd "$ROOT_DIR"
TMP_DIR="$(mktemp -d /tmp/spotifylyrics-personal-data-package.XXXXXX)"
...
swiftc -parse-as-library \
  ...
  Tests/personal_data_package_contract.swift \
  -o "$TMP_DIR/personal-data-package-contract"

"$TMP_DIR/personal-data-package-contract"
