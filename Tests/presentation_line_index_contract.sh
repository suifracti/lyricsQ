...
require "$V3" 'let currentIndex = liveOnly \? state.liveCurrentLineIndex : state.currentLineIndex' 'V3 reads published index'
...
require "$FULLSCREEN" 'AppleMusicImmersiveV3WindowView' 'fullscreen shares index-change scrolling'
require "$FULLSCREEN" 'liveOnly: true' 'fullscreen selects the live index'
